    ...
    <?php else : ?>
        ...
        <main>
            ...
            <div class="mfs__wrapper">
                <div class="mfs">
                    <div class="features__left revealjs">
                    ...
                    <div class="features__right revealjs">
                ...
                <div class="extra">
                    <div class="extra__recents">
                        <div class="recents__img-div">
                            <img class="extra__img recents__img revealjs" src="../assets/img/recents.png" alt="Recent transactions section image">
                        </div>
                        <div>
                    ...
                    <div class="extra__expenses">
                        <div class="expenses__img-div">
                            <img class="extra__img expenses__img revealjs" src="../assets/img/expenses.png" alt="Expenses section image">
                        </div>
                        <div>
